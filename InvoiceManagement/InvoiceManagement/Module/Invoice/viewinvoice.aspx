<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="viewinvoice.aspx.cs" Inherits="InvoiceManagement.Module.Invoice.viewinvoice1" %>
    ...
    <form id="form1" runat="server">
            ...
            <section id="pdfdiv" class="invoice row">
                <div class="col-md-8">
                    ...
                    <div class="pull-right">
                        <a class="btn btn-default" href="viewinvoicereport.aspx?invid=<%= Request.QueryString["invid"] %>" target="_blank" >Save PDF</a>
                        <asp:LinkButton ID="btnprint" runat="server" CssClass="btn btn-default" OnClick="btnprint_Click" Visible="false">Save</asp:LinkButton>
                        <asp:LinkButton ID="lnkback" runat="server" CssClass="btn btn-default disabled" OnClick="lnkback_Click" Enabled="false">Back to edit</asp:LinkButton>
                        <a class="btn btn-default" href="newinvoice.aspx">Back to New Bill</a>
                    </div>
                            ...
                            <asp:Repeater ID="rptbillproduct" runat="server" OnItemDataBound="rptbillproduct_ItemDataBound">
                                ...
                                <ItemTemplate>
                                    <tr style="border: 1px solid;">
                                        ...
                                        <td style="border: 1px solid; padding: 2px; margin: 1px;" class="text-right" width="25%">&nbsp;<%# Eval("Total") %></td>
                                    </tr>
                                </ItemTemplate>
                                <FooterTemplate>
                                    </tbody>
     ...
     $('input').iCheck({
        ...
        <script>
            ...
            //    debugger;
            //    var path = bill;
            //    window.Location = "/viewinvoicereport.aspx?invid=" + bill + "&flg=1";
            //}
